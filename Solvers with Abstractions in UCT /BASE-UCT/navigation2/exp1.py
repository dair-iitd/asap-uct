...
for j in range(10):
	time=time+100
	print(sys.argv[1]+"/navigation1  -f -a 0 -h 0 -s 0 -t 1000 100 random uct 0 50 "+str(time))
	os.system(sys.argv[1]+"/navigation1  -f -a 0 -h 0 -s 0 -t 1000 100 random uct 0 50 "+str(time)+" >> " +sys.argv[2])
