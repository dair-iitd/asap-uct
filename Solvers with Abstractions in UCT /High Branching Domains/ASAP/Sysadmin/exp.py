...
for j in range(8):
	print(sys.argv[1]+"/sysadmin  -f -a 0 -h 0 -s 0 -t 1000 100 random uct "+sys.argv[2]+" 40 "+str(time))
	os.system(sys.argv[1]+"/sysadmin  -f -a 0 -h 0 -s 0 -t 1000 100 random uct "+sys.argv[2]+" 40 "+str(time)+" >> " +sys.argv[3]+str(j)) 
	time=time+20
