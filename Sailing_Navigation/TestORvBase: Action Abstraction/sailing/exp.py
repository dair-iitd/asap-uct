...
for j in range(7):
	time=time+10
	print(sys.argv[1]+"/sailing  -f -a 0 -h 0 -s 0 -t 1000 100 random uct 1 30 "+str(time))
	os.system(sys.argv[1]+"/sailing  -f -a 0 -h 0 -s 0 -t 1000 100 random uct 1 30 "+str(time)+" >> " +sys.argv[2])
