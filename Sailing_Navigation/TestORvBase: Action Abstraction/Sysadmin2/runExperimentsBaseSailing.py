...
for j in range(8):
	width=width+j*3
	print(sys.argv[1]+"/sysadmin  -f -a 0 -h 0 -s 0 -t 1000 100 random uct "+str(width[j])+" 30 0")
	os.system(sys.argv[1]+"/sysadmin  -f -a 0 -h 0 -s 0 -t 1000 100 random uct "+str(width[j])+" 30 0"+" >> " +sys.argv[2])
