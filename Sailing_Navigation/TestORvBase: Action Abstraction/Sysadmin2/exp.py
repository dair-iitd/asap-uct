...
for j in range(10):
	time=time+50
	print(sys.argv[1]+"/sysadmin  -f -a 0 -h 0 -s 0 -t 1000 100 random uct "+"2 30 "+str(time))
	os.system(sys.argv[1]+"/sysadmin  -f -a 0 -h 0 -s 0 -t 1000 100 random uct "+"2 30 "+str(time)+" >> " +sys.argv[2])
