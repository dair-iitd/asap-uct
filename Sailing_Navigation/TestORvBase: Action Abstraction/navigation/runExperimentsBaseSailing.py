...
for j in range(6):
	print(sys.argv[1]+"/sailing  -f -a 0 -h 0 -s 0 -t 1000 100 random uct "+str(width[j])+" 50 0")
	os.system(sys.argv[1]+"/sailing  -f -a 0 -h 0 -s 0 -t 1000 100 random uct "+str(width[j])+" 50 0"+" >> " +sys.argv[2])
