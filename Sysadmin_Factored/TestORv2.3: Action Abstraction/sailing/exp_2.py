...
for j in range(10):
	time=time+25
	print(sys.argv[1]+"/sailing  -f -a 0 -h 0 -s 0 -t 1000 20 random uct 3 50 "+str(time))
	os.system(sys.argv[1]+"/sailing  -f -a 0 -h 0 -s 0 -t 1000 20 random uct 3 50 "+str(time)+" >> " +sys.argv[2])
