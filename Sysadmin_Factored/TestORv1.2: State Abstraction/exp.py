...
for j in range(7):
	print(sys.argv[1]+"/sysadmin  -f -a 0 -h 0 -s 0 -t 1000 100 random uct "+sys.argv[2]+" 40 "+str(width[j]))
	os.system(sys.argv[1]+"/sysadmin  -f -a 0 -h 0 -s 0 -t 1000 100 random uct "+sys.argv[2]+" 40 "+str(width[j])+" >> " +sys.argv[3])
	width=width+700	
